...
**HTTPS (no access assumed — public bits only; the private config is silently skipped and `.config/secrets` is left alone until age encryption is configured, see below):**
